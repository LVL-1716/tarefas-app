...
export default function Home() {
  ...
  if (isLoading) {
    return (
      <main className="min-h-screen bg-tarefas-pattern dark:from-gray-900 dark:to-gray-800 py-8">
  ...
  return (
    <main className="min-h-screen bg-tarefas-pattern dark:from-gray-950 dark:to-gray-900 py-8 transition-colors">
